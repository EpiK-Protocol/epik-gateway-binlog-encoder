...
Spark job that encoding triplets to Epik knowledge graph [binary-log](https://github.com/EpiK-Protocol/epik-gateway-binlog-encoder/blob/master/binlog.md) files.
